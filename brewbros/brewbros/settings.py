"""
Django settings for brewbros project.
...
SECRET_KEY = 'django-insecure-0x-pgnu6u^i8+)4w3f)t)7x^6f)w6w+p8)-%-v^j#1j0f+*y6u'
...
WSGI_APPLICATION = 'brewbros.wsgi.application'
